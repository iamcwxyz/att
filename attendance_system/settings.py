...
SECRET_KEY = 'django-insecure-tk9r%39k7m1zfg9$oo2*5ty75@49p+xh@xb!p((_d^ix+_3ad9'
...
if 'REPL_SLUG' in os.environ and 'REPL_OWNER' in os.environ:
    CSRF_TRUSTED_ORIGINS.append(f"https://{os.environ['REPL_SLUG']}.{os.environ['REPL_OWNER']}.repl.co")
